...
function AttendanceReport() {
  return (
    <div className="p-[10px] bg[#F7F7F7]">
      ...
      <div className="w-[50%]">
        ...
        <div className="flex justify-between items-center mt-[10px]">
          ...
          <button className="w-[150px] p-[10px] bg-lp-secondary border rounded-md text-white font-bold">
            Generate
          </button>
        </div>
      </div>
      <div className="text-lg font-bold flex justify-between items-center border border-transparent border-t-gray-400 border-b-gray-400 py-[10px]">
        <div>{new Date().toDateString()}</div>
        <button className="flex justify-center items-center hover:text-white p-[10px] border border-[2px] border-lp-primary rounded-md w-[200px] font-bold text-white bg-lp-primary">
